# v0.14: Sophisticated Intelligence

**Theme**: Fine-tuned models, multi-turn context, and agentic workflows. The intelligence layer matures.

v0.7-v0.13 shipped auto-embedding and natural language search using off-the-shelf models. v0.14 makes the intelligence layer genuinely smart: models fine-tuned for Strata's query patterns, search that remembers conversation history, and proactive data organization.
...
- v0.13 (advanced NL search — fine-tuning builds on established search pipeline)
