...
|------|---------|------------|-------------------|----------|
| **InMemory** | <3 us | 250K+ ops/sec | All data | Testing, ephemeral workloads |
...
- [Architecture: Durability and Recovery](../architecture/durability-and-recovery.md) — deep dive into WAL format, snapshots, and recovery internals
